...
class CPUVC: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func newDare(sender: AnyObject) {
        newDare()
    }
    ...
    func newDare() {
        var newQuestion = Int(arc4random_uniform(UInt32(questionList.count)))
        dareQuestion.text = questionList[newQuestion]
    }
    ...
    override func viewDidLoad() {
        ...
        self.RangeInputToTextField.delegate = self
